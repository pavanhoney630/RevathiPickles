...
exports.registerUser = catchAsyncErrors(async (req, res, next) => {
  ...
  console.log("REQ BODY:", req.body); // should show name, email, password
...
console.log("REQ FILE:", req.file); // should be your avatar file
  let uploadedImage;
  try {
    ...
    return next(
      new ErrorHandler("Image upload failed. Please upload a valid image file.", 500)
    );
  }
